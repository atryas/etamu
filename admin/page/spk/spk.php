                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="example1">
                                  ...
                                  <a href="page/spk/cetak_excel.php" class="btn btn-default" target="blank" style="margin-bottom:  12px; margin-left: 5px;"><i class="fa fa-print"></i> Cetak Excel</a>

                                  <?php } else { ?> 

                                  <a href="page/spk/cetak_excel2.php?unit_kerja=<?php echo $unit_kerja ?>" class="btn btn-default" target="blank" style="margin-bottom:  12px; margin-left: 5px;"><i class="fa fa-print"></i> Cetak Excel</a>

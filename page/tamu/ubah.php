              ...
              <div class="modal-body">
                <table class="table table-striped table-bordered table-hover" id="example1">
                                    ...
                                    <tbody>
                                       ...
                                       echo"
											<tr style='cursor:pointer' class='pilih' data-nama='$r[nama_peg]'>
...
<?php
    ...
    $koneksi->query("UPDATE  tb_tamu SET  nama='$nama', alamat='$alamat', telp='$telp', jk='$jk', keperluan='$perlu', tanggal='$tgl', jam='$jam', ketemu='$temu', petugas='$user'  where id_tamu='$id'");
